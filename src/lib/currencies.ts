...
export const ALL_CURRENCIES: Currency[] = [
  ...
  { code: "BAM", name: "Bosnia-Herzegovina Convertible Mark", symbol: "КМ" },
  ...
  { code: "VED", name: "Venezuelan Bolívar Soberano", symbol: "Bs.S" },
...
// Helper function to get currency display name (with code)
